...
namespace Aries\Gateway\Mellat;
...
class Mellat extends PortAbstract implements PortInterface
{
	...
	{
		if (!$this->callbackUrl)
			$this->callbackUrl = Setting::get('mellat-cb-url', '/');
	...
	protected function sendPayRequest()
	{
		...
		$fields = array(
			'terminalId' => Setting::get('mellat-terminal'),
			'userName' => Setting::get('mellat-username'),
			'userPassword' => Setting::get('mellat-password'),
